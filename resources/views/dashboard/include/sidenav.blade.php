        ...
        <a href="../dashboard/index.html" class="navbar-brand">
            ...
            <div class="logo-main">
                <div class="logo-normal">
                    <svg class="animated-rotate icon-30" viewBox="0 0 30 30" fill="none"
            ...
            <h4 class="logo-title">{{ config('app.name', 'DAVNOR-HIS') }}</h4>
        </a>
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{ route('dashboard_home') }}">
                        <i class="icon">
                        ...
                        <span class="item-name">Dashboardadsasdasd</span>
                    </a>
                </li>
                <li><hr class="hr-horizontal"></li>
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled" href="#" tabindex="-1">
                        <span class="default-icon">Master List</span>
                        <span class="mini-icon">-</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('directory_patient') }}">
                        <i class="icon">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('directory_doctor') }}">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('directory_guarrantor') }}">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="item-name">Guarrantors</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('directory_item_services') }}">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="icon-20">
                                <path opacity="0.4"
                        ...
                        <span class="item-name">Items and Services</span>
                    </a>
                </li>
            </ul>
            <!-- Sidebar Menu End -->
