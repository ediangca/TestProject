    ...
    <div class="container-fluid">
        <div class="row">
            <nav class="navbar navbar-expand-lg"> <!-- bg-body-tertiary -->
                <div class="container-fluid">
                    <a class="navbar-brand" href="/"><img class="img-fluid" src="{{ asset('img/logo.png') }}"
                            alt="IAS " width="100" height="50"></a>
                    ...
                    <div class="float-right nav ms-auto">
                        ...
                        @else
                            ...
                            <button value="logout" class="btn btn-outline-secondary fs-5 px-3 logout" id="dropdown-item logout"
                                data-bs-toggle="modal" data-bs-target="#logoutmodal"><i class="bi bi-power"
                                    data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="LOGOUT"></i></button>
                        @endguest
                    </div>
...
@section('content')
    <div class="container-fluid pis-dashboard">
        <div class="row">
            <div class="col-5 col-md-3 offcanvas offcanvas-start bg-light" data-cs-scroll="true" data-bs-backdrop="true"
                tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
                <div class="offcanvas-header text-success">
                    <a class="navbar-brand" href="/"><img class="img-fluid" src="{{ asset('img/logo.png') }}"
                            alt="IAS " width="100" height="50"></a>

                    <a class="btn-close text-reset text-white" type="button" data-bs-dismiss="offcanvas"
                        area-label="Close">
                ...
                <div class="offcanvass-body side-nav p-0">
                    ...
                    <div class="accordion" id="accordionPanelsStayOpenExample">
                        <div class="accordion-item bg-dark-subtle ms-auto">
                            <a class="btn fw-bold text-start w-100" href="{{ route('dashboard_home') }}"><i
                                    class="bi bi-window-sidebar">
                                    &nbsp;DASHBOARD</i></a>
                            <a class="btn fw-bold text-start w-100" type="button" data-bs-toggle="collapse"
                                data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true"
                                aria-controls="panelsStayOpen-collapseOne"><i class="bi bi-folder">
                                ...
                                <div class="accordion-body p-0 px-3">
                                    <a class="btn fw-bold text-start w-100" href="{{ route('directory_patient') }}">
                                        <i class="bi bi-people">&nbsp;
                                            PATIENTS</i></a>
                                    <a class="btn fw-bold text-start w-100"
                                        href="{{ route('directory_item_services') }}">
            ...
            <div class="col">
                <div class="row">
                    <div class="col-2 col-sm-2 col-md-1 col-lg-1 side-nav-col pt-0 pb-3 ">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-light text-center">
                            <li class="nav-item">
                                <a class="btn btn-outline-primary w-100 fs-3 p-0" type="button"
                                    data-bs-toggle="offcanvas"data-bs-target="#offcanvasScrolling"
                                    aria-controls="offcanvasScrolling">
                                    <i class="bi bi-justify" data-bs-toggle="tooltip" data-bs-placement="right"
                                        data-bs-title="MENU"></i>
                                </a>
                            </li>
                            <hr class="text-dark m-1">
                            <li class="nav-item">
                                <a class="btn btn-outline-primary w-100 fs-3 p-0" type="button" id="btn-dashboard"
                                    href="{{ route('dashboard_home') }}" data-bs-toggle="tooltip"
                            ...
                            <li class="nav-item">
                                <a class="btn btn-outline-primary w-100 fs-3 p-0" type="button" id="btn-dashboard"
                                    href="{{ route('dashboard_home') }}" data-bs-toggle="tooltip"
                                    data-bs-placement="right" data-bs-title="OUTPATIENTS"><i
                                        class="bi bi-person-fill-up"></i>
                                </a>
                            </li>
                            <hr class="text-dark m-1">
                            <li class="nav-item">
                                <a class="btn btn-outline-primary w-100 fs-3 p-0" type="button" id="btn-dashboard"
                                    href="{{ route('dashboard_home') }}" data-bs-toggle="tooltip"
                                    data-bs-placement="right" data-bs-title="EMERGENCIES"><i
                            ...
                            <li class="nav-item">
                                <a class="btn btn-outline-primary w-100 fs-3 p-0" type="button" id="btn-dashboard"
                                    href="{{ route('dashboard_home') }}" data-bs-toggle="tooltip"
                                    data-bs-placement="right" data-bs-title="INPATIENTS"><i
                                        class="bi bi-person-fill-down"></i>
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-10 col-sm col-md col-lg text-light">
                        @yield('title-entity')
                        @yield('board-content')
                    </div>
                </div>
